...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  <ul class="navbar-nav">
    <li class="nav-item active">
      <a class="nav-link" href="seat.request.php">Seat Requests</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" style="color: green;font-size: 25px;font-weight: bold;">Seat Confirmed</a>
    </li>
  </ul>
</nav>
...
$query = "SELECT * FROM reservation WHERE status=1;";
