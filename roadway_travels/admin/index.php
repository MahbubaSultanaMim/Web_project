...
<nav class="navbar navbar-expand-sm bg-light navbar-light">
  <ul class="navbar-nav">
    <li class="nav-item active">
      <a class="nav-link" href="seat.request.php" style="color:red  ">Seat Requests</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="seat.confirm.php" style="color: green;">Seat Confirmed</a>
    </li>
  </ul>
</nav>
</div>
...
<div>
<img src="../picture/pic2.jpg" style="height: 480px;width: 1340px;">
<div>
